...
/**
 * @ParagraphsBehavior(
 *    id = "drupalblog_paragraphs_remote_video_gallery",
...
class RemoteVideoGalleryBehavior extends ParagraphsBehaviorBase {
  ...
  public function buildBehaviorForm(ParagraphInterface $paragraph, array &$form, FormStateInterface $form_state) {
    $form['items_per_row'] = [
      ...
      '#options' => [
        '2' => $this->formatPlural(2, '1 video per row', '@count video per row'),
        '3' => $this->formatPlural(3, '1 video per row', '@count video per row'),
        '4' => $this->formatPlural(4, '1 video per row', '@count video per row'),
      ],
